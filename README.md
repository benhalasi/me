# Collection of stuff I typed into a computer and didn't throw compile time errors.
...
This project is deployed via [GitHub Pages](https://bhalasi.github.io/bh/) and is mirrored by [benedek.dev](https://benedek.dev/).
